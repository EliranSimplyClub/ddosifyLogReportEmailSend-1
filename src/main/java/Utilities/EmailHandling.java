...
public class EmailHandling extends Constant {
    ...
    /**
     *
     * @param ddosifyJenkinsRunLogLocation the location of the ddosify log file
    ...
    public static void sendEnmail(String ddosifyJenkinsRunLogLocation , String Subject) {
        ...
        try {
            ...
            messageBodyPart1.setText(LogFileHandling.ReadFile("EmailLog_dosifyLogFile","C:\\Users\\User\\IdeaProjects\\ddosify_0.7.5_windows_amd64"));
            ...
            String filename = ddosifyJenkinsRunLogLocation;
